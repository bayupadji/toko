                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                <div class="pt active" data-imgbigurl="<?= base_url('img/products/' . $barang->gambar . '') ?>"><img src="<?= base_url('img/products/' . $barang->gambar . '') ?>" alt=""></div>
                                <div class="pt" data-imgbigurl="<?= base_url('img/products/' . $barang->gambar . '') ?>"><img src="<?= base_url('img/products/' . $barang->gambar . '') ?>" alt=""></div>
                                <div class="pt" data-imgbigurl="<?= base_url('img/products/' . $barang->gambar . '') ?>"><img src="<?= base_url('img/products/' . $barang->gambar . '') ?>" alt=""></div>
                                <div class="pt" data-imgbigurl="<?= base_url('img/products/' . $barang->gambar . '') ?>"><img src="<?= base_url('img/products/' . $barang->gambar . '') ?>" alt=""></div>
                            </div>
                        </div>
                        ...
                        <div class="product-details">
                            ...
                            <div class="pd-desc">
                                ...
                                <?php if ($session->get('isLoggedIn')) : ?>
                                    ...
                                    <div class="form-group">
                                        <?= form_label('Voucher Diskon', 'voucher') ?>
                                        <?= form_input($voucher) ?>
                                    </div>
                                    <div class="form-group">
